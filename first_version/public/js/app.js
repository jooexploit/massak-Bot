...
function setupEventListeners() {
  ...
  if (adsWebsiteFilter)
    adsWebsiteFilter.addEventListener("change", fetchAndRenderAds);
  if (adsGroupFilter)
        ...
        <div class="ad-faq-content" data-ad-id="${
          ...
          <div style="margin-bottom: 20px;">
            ...
            <div style="padding: 15px; background: white; border: 2px solid #667eea; border-top: none; border-radius: 0 0 6px 6px; display: flex; flex-direction: column; align-items: center; gap: 10px;">
              <img 
                ...
                onerror="if(!this.dataset.errorHandled){this.dataset.errorHandled='true';this.src='${
              ...
              <div style="display: flex; gap: 10px; flex-wrap: wrap; justify-content: center;">
                <button class="btn btn-sm btn-primary" onclick="openAdImageFullView('${
                  ad.id
                }')" style="display: flex; align-items: center; gap: 5px;">
                  <i class="fas fa-expand"></i> View Full Image
                </button>
                <button class="btn btn-sm btn-danger" onclick="removeAdImage('${
                  ad.id
                }')" style="display: flex; align-items: center; gap: 5px;">
          ...
          <div style="background: #fff3cd; padding: 12px; border-radius: 8px; margin-top: 15px; border-left: 4px solid #ffc107;">
            <div style="margin-bottom: 10px;">
              ...
              <small style="color: #666; display: block; margin-top: 5px;">
                تم الرفض: ${
                  ad.rejectedAt
                    ? new Date(ad.rejectedAt).toLocaleString("ar-SA")
                    : "N/A"
                }
              </small>
            </div>
            <div style="display: flex; gap: 10px; flex-wrap: wrap;">
              <button class="btn btn-sm btn-danger" data-action="move-to-recycle-bin" data-id="${
                ad.id
              }" 
                style="background: linear-gradient(135deg, #e74c3c 0%, #c0392b 100%); border: none;">
                🗑️ نقل إلى سلة المحذوفات / Send to Recycle Bin
              </button>
              <button class="btn btn-sm btn-secondary" data-action="edit-wp" data-id="${
                ad.id
              }">
                ✏️ Edit
              </button>
          ...
          <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:15px;align-items:center;padding-top:15px;border-top:2px solid #e0e0e0;">
            <select class="form-control" data-id="${
              ad.id
            }" style="max-width:150px;padding:6px;font-size:0.9rem;">
              <option value="">Set Category</option>
            </select>
            <button class="btn btn-sm btn-primary" data-action="wp-direct" data-id="${
              ad.id
            ...
            <button class="btn btn-sm btn-danger" data-action="reject" data-id="${
              ad.id
            }">✗ Reject</button>
            <button class="btn btn-sm btn-secondary" data-action="edit-wp" data-id="${
              ad.id
            }">✏️ Edit</button>
            <button class="btn btn-sm btn-secondary" data-action="regenerate" data-id="${
              ad.id
            }">🔄 Regenerate</button>
          </div>
          `
